 ...
 * 名称：SolidToast
 * 作用：吐司工具
 * 描述：吐司工具 在屏幕一个区域内显示有背景色样式的饿吐司
 * 作者：pczhu
 * 创建时间： 15/12/28 下午3:03
 * 版本：V1.0
 * 修改历史：
 */
    ...
    public static void hideToastView(Activity activity) {
        ...
        if (view != null && view.getVisibility() == View.VISIBLE) {
            AlphaAnimation alphaAnimation = (AlphaAnimation) AnimationUtils
                    .loadAnimation(activity, R.anim.solidtoast_fade_out);
