...
import cn.mobile.renrentou.utils.ThreadPoolUtils;
...
public class HttpAction {
    ...
    public static RequestParams getRequestParams(String url){
        ...
        String signTime = ""+ TimeUtils.getTime();
        requestParams.addBodyParameter("access_token",""+ AccountUtils.getAppAccessToken(mContext));
        requestParams.addBodyParameter("sign",""+AccountUtils.getSign(signTime,mContext));
